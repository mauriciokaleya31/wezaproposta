        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-3 lg:col-span-2">
            <RevealOnScroll direction="left" className="h-full">
              <div className="bg-vortex-dark rounded-2xl p-8 md:p-12 shadow-xl text-white relative overflow-hidden group h-full">
          ...
          <div className="space-y-8 lg:col-span-1">
            ...
            <RevealOnScroll direction="right" delay={200}>
              <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 border border-gray-100 h-full flex flex-col justify-center">
